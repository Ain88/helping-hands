Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ 'https://helpvan-front.herokuapp.com/', /http:\/\/helpvan-front.herokuapp.com.*/ ]
  ...
  # config.active_job.queue_name_prefix = "help_van_production"
